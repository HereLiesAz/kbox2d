...
class DefaultWorldPool(argSize: Int, argContainerSize: Int) : WorldPool {
    ...
    private val pcstack: MutableStack<Contact> = object : MutableStack<Contact>(
    ...
    private val ccstack: MutableStack<Contact> = object : MutableStack<Contact>(
        Settings.CONTACT_STACK_INIT_SIZE
    ) {
        override fun newInstance(): Contact {
    ...
    private val cpstack: MutableStack<Contact> = object : MutableStack<Contact>(
        Settings.CONTACT_STACK_INIT_SIZE
    ) {
        override fun newInstance(): Contact {
    ...
    private val ecstack: MutableStack<Contact> = object : MutableStack<Contact>(
        Settings.CONTACT_STACK_INIT_SIZE
    ) {
        override fun newInstance(): Contact {
    ...
    private val epstack: MutableStack<Contact> = object : MutableStack<Contact>(
        Settings.CONTACT_STACK_INIT_SIZE
    ) {
        override fun newInstance(): Contact {
    ...
    private val chcstack: MutableStack<Contact> = object : MutableStack<Contact>(
        Settings.CONTACT_STACK_INIT_SIZE
    ) {
        override fun newInstance(): Contact {
    ...
    private val chpstack: MutableStack<Contact> = object : MutableStack<Contact>(
        Settings.CONTACT_STACK_INIT_SIZE
    ) {
        override fun newInstance(): Contact {
